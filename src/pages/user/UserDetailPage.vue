<template>
    ...
    <div style="margin: 16px">
        <div v-if="user?.id !== currentUser?.id">
            ...
            <div v-if="addUserApply">
                <van-button style="width: 100%;margin-top: 10px" plain round type="primary" @click="addUser">
                    加好友
                </van-button>
            </div>
            <div v-else>
                <van-button style="width: 100%;margin-top: 10px" 
                 plain round type="primary" @click="toChat" block>联系好友</van-button>
            <van-button style="width: 100%;margin-top: 10px" 
            plain round type="danger" @click="deleteFriend" block>删除好友</van-button>
            </div>
        </div>
    </div>
