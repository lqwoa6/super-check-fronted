...
function createTranslate(name106) {
  const prefix = camelize(name106) + ".";
  return (path, ...args) => {
...
function genBem(name106, mods) {
  ...
  if (Array.isArray(mods)) {
    return mods.reduce(
      (ret, item) => ret + genBem(name106, item),
      ""
    );
  }
  return Object.keys(mods).reduce(
    (ret, key) => ret + (mods[key] ? genBem(name106, key) : ""),
    ""
  );
}
function createBEM(name106) {
  return (el, mods) => {
    if (el && typeof el !== "string") {
      mods = el;
      el = "";
    }
    el = el ? `${name106}__${el}` : name106;
    return `${el}${genBem(el, mods)}`;
  };
}
function createNamespace(name106) {
  const prefixedName = `van-${name106}`;
  return [
    prefixedName,
...
function withInstall(options) {
  options.install = (app) => {
    const { name: name106 } = options;
    if (name106) {
      app.component(name106, options);
      app.component(camelize(`-${name106}`), options);
    }
  };
  return options;
}
...
function useId() {
  ...
  const { name: name106 = "unknown" } = (vm == null ? void 0 : vm.type) || {};
  if (false) {
    return name106;
  }
  return `${name106}-${++current}`;
}
...
var Swipe = withInstall(stdin_default17);
...
var stdin_default19 = defineComponent({
  ...
  setup(props, {
    ...
    }) : renderHeader(), createVNode(stdin_default18, {
      "ref": contentRef,
...
var SwipeItem = withInstall(stdin_default20);
...
var Tab = withInstall(stdin_default21);

// node_modules/vant/es/tabs/index.mjs
var Tabs = withInstall(stdin_default19);
...
var Picker = withInstall(stdin_default23);
...
var Area = withInstall(stdin_default24);
...
var Cell = withInstall(stdin_default25);
...
var Form = withInstall(stdin_default26);
...
var Field = withInstall(stdin_default27);
  ...
  const {
    ...
    setup() {
      ...
      const render = () => {
        ...
        return createVNode(stdin_default28, mergeProps(state, attrs), null);
      };
      watch(message, (val) => {
        state.message = val;
      });
...
var Toast = withInstall(stdin_default28);
...
var Switch = withInstall(stdin_default29);
    ...
    return () => {
      ...
      return createVNode(Form, {
        ...
        default: () => {
          ...
          }, null), [[vShow, props.showArea]]), createVNode(stdin_default30, {
...
var AddressEdit = withInstall(stdin_default31);
...
var RadioGroup = withInstall(stdin_default32);
...
var Tag = withInstall(stdin_default33);
...
var stdin_default34 = defineComponent({
  ...
  setup(props, {
    ...
    const iconRef = ref();
    const getParentProp = (name106) => {
      if (props.parent && props.bindGroup) {
        return props.parent.props[name106];
      }
    };
...
var stdin_default35 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode(stdin_default34, mergeProps({
      "bem": bem32,
      "role": "radio",
      "parent": parent,
      "checked": checked(),
...
var Radio = withInstall(stdin_default35);
...
var stdin_default37 = defineComponent({
  ...
  setup(props, {
    ...
    const renderItem = (item, index, disabled) => {
      ...
      return createVNode(stdin_default36, {
        "key": item.id,
        "address": item,
        "disabled": disabled,
...
var AddressList = withInstall(stdin_default37);
...
var BackTop = withInstall(stdin_default38);
...
var stdin_default40 = defineComponent({
  ...
  setup(props, {
    ...
    const renderDay = (item, index) => createVNode(stdin_default39, {
      "item": item,
      "index": index,
      "color": props.color,
...
var stdin_default42 = defineComponent({
  ...
  setup(props, {
    ...
    const renderMonth = (date, index) => {
      ...
      return createVNode(stdin_default40, mergeProps({
...
var Calendar = withInstall(stdin_default42);
...
var Image2 = withInstall(stdin_default43);
...
var Card = withInstall(stdin_default44);
...
var Cascader = withInstall(stdin_default45);
...
var CellGroup = withInstall(stdin_default46);
...
var Checkbox = withInstall(stdin_default48);

// node_modules/vant/es/checkbox-group/index.mjs
var CheckboxGroup = withInstall(stdin_default47);
...
var Circle = withInstall(stdin_default49);
...
var Col = withInstall(stdin_default51);
...
var Collapse = withInstall(stdin_default52);
...
var CollapseItem = withInstall(stdin_default53);
...
var ContactCard = withInstall(stdin_default54);
...
var ContactEdit = withInstall(stdin_default55);
...
var ContactList = withInstall(stdin_default56);
...
var CountDown = withInstall(stdin_default57);
...
var Coupon = withInstall(stdin_default58);
...
var CouponCell = withInstall(stdin_default59);
...
var Empty = withInstall(stdin_default60);
...
var CouponList = withInstall(stdin_default61);
...
var DatePicker = withInstall(stdin_default62);
...
var Dialog = withInstall(stdin_default63);
...
var stdin_default70 = defineComponent({
  ...
  setup(props, {
    ...
    const renderImages = () => createVNode(Swipe, {
      ...
      default: () => [props.images.map((image, index) => createVNode(stdin_default69, {
        "src": image,
        "show": props.show,
        "active": state.active,
...
var ImagePreview = withInstall(stdin_default70);
...
var Notify = withInstall(stdin_default76);
...
var PickerGroup = withInstall(stdin_default22);
  ...
  return function createPopper2(reference, popper, options) {
    ...
    var instance4 = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (true) {
          var modifiers = uniqueBy([].concat(orderedModifiers, state.options.modifiers), function(_ref) {
            var name106 = _ref.name;
            return name106;
          });
          validateModifiers(modifiers);
          if (getBasePlacement(state.options.placement) === auto) {
            var flipModifier = state.orderedModifiers.find(function(_ref2) {
              var name106 = _ref2.name;
              return name106 === "flip";
            });
            if (!flipModifier) {
      ...
      forceUpdate: function forceUpdate() {
        ...
        for (var index = 0; index < state.orderedModifiers.length; index++) {
          ...
          var _state$orderedModifie = state.orderedModifiers[index], fn2 = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = _state$orderedModifie2 === void 0 ? {} : _state$orderedModifie2, name106 = _state$orderedModifie.name;
    ...
    function runModifierEffects() {
      state.orderedModifiers.forEach(function(_ref3) {
        var name106 = _ref3.name, _ref3$options = _ref3.options, options2 = _ref3$options === void 0 ? {} : _ref3$options, effect3 = _ref3.effect;
...
function popperOffsets(_ref) {
  var state = _ref.state, name106 = _ref.name;
  state.modifiersData[name106] = computeOffsets({
...
function applyStyles(_ref) {
  ...
  Object.keys(state.elements).forEach(function(name106) {
    var style = state.styles[name106] || {};
    var attributes = state.attributes[name106] || {};
    var element = state.elements[name106];
...
function effect2(_ref2) {
  ...
  return function() {
    Object.keys(state.elements).forEach(function(name106) {
      var element = state.elements[name106];
      var attributes = state.attributes[name106] || {};
      var styleProperties = Object.keys(state.styles.hasOwnProperty(name106) ? state.styles[name106] : initialStyles[name106]);
...
function offset(_ref2) {
  var state = _ref2.state, options = _ref2.options, name106 = _ref2.name;
  ...
  state.modifiersData[name106] = data;
}
var offset_default = {
  name: "offset",
  enabled: true,
...
var Row = withInstall(stdin_default50);
...
var [name86, bem82, t19] = createNamespace("signature");
var signatureProps = {
  tips: String,
...
var stdin_default89 = defineComponent({
  ...
  setup(props, {
    ...
    return () => createVNode("div", {
      ...
      default: () => [props.clearButtonText || t19("clear")]
    }), createVNode(Button, {
      "type": "primary",
      "size": "small",
      "onClick": submit
    }, {
      default: () => [props.confirmButtonText || t19("confirm")]
    })])]);
  }
});

// node_modules/vant/es/signature/index.mjs
var Signature = withInstall(stdin_default89);

// node_modules/vant/es/skeleton-title/SkeletonTitle.mjs
var [name87, bem83] = createNamespace("skeleton-title");
...
var [name88, bem84] = createNamespace("skeleton-avatar");
...
var [name89, bem85] = createNamespace("skeleton-paragraph");
...
var [name90, bem86] = createNamespace("skeleton");
...
var [name91, bem87] = createNamespace("skeleton-image");
...
var [name92, bem88] = createNamespace("slider");
var sliderProps = {
  ...
  setup(props, {
    ...
    const getButtonClassName = (index) => {
      if (typeof index === "number") {
        ...
        return bem88(`button-wrapper`, position[index]);
      }
      return bem88("button-wrapper", props.reverse ? "left" : "right");
    };
...
var [name93, bem89] = createNamespace("space");
var spaceProps = {
  align: String,
  direction: {
    type: String,
...
var [name94, bem90] = createNamespace("steps");
var stepsProps = {
  active: makeNumericProp(0),
...
var [name95, bem91] = createNamespace("step");
var stdin_default101 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "class": [BORDER, bem91([parentProps.direction, {
          [status]: status
        }])]
      }, [createVNode("div", {
        "class": bem91("title", {
...
var [name96, bem92] = createNamespace("stepper");
...
var [name97, bem93, t20] = createNamespace("submit-bar");
var submitBarProps = {
  tip: String,
  label: String,
  price: Number,
...
var stdin_default103 = defineComponent({
  ...
  setup(props, {
    ...
    const root = ref();
    const renderPlaceholder = usePlaceholder(root, bem93);
    const renderText = () => {
      const {
        price,
        label,
      ...
      if (typeof price === "number") {
        ...
        return createVNode("div", {
          ...
          "class": bem93("price-integer")
        }, [pricePair[0]]), decimal]), suffixLabel && createVNode("span", {
          "class": bem93("suffix-label")
        }, [suffixLabel])]);
      }
    };
    const renderTip = () => {
      ...
      if (slots.tip || tip) {
        return createVNode("div", {
          ...
          "class": bem93("tip-icon"),
          "name": tipIcon
        }, null), tip && createVNode("span", {
          "class": bem93("tip-text")
    ...
    const renderButton = () => {
      ...
      return createVNode(Button, {
        ...
        "class": bem93("button", props.buttonType),
...
var [name98, bem94] = createNamespace("swipe-cell");
var swipeCellProps = {
  name: makeNumericProp(""),
  disabled: Boolean,
...
var [name99, bem95] = createNamespace("tabbar");
var tabbarProps = {
  route: Boolean,
  fixed: truthProp,
  border: truthProp,
...
var stdin_default105 = defineComponent({
  ...
  setup(props, {
    ...
    const renderPlaceholder = usePlaceholder(root, bem95);
...
var [name100, bem96] = createNamespace("tabbar-item");
...
var [name101, bem97] = createNamespace("text-ellipsis");
...
var [name102] = createNamespace("time-picker");
...
var [name103, bem98] = createNamespace("tree-select");
var treeSelectProps = {
  max: makeNumericProp(Infinity),
  items: makeArrayProp(),
  ...
  setup(props, {
    ...
    const renderSidebar = () => {
      const Items = props.items.map((item) => createVNode(SidebarItem, {
        "dot": item.dot,
        "badge": item.badge,
        "class": [bem98("nav-item"), item.className],
        "disabled": item.disabled,
...
var [name104, bem99, t21] = createNamespace("uploader");
  ...
  setup(props, {
    ...
    const renderDeleteIcon = () => {
      if (props.deletable && props.item.status !== "uploading") {
        ...
        return createVNode("div", {
          ...
          "name": "cross",
          "class": bem99("preview-delete-icon")
        }, null)]);
      }
    };
    const renderCover = () => {
    ...
    const renderPreview = () => {
      ...
      return createVNode("div", {
        ...
        "class": bem99("file-icon"),
        "name": "description"
      }, null), createVNode("div", {
        "class": [bem99("file-name"), "van-ellipsis"]
...
var stdin_default111 = defineComponent({
  ...
  setup(props, {
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return createVNode(stdin_default110, mergeProps({
        "item": item,
        "index": index,
    ...
    const renderUpload = () => {
      ...
      return withDirectives(createVNode("div", {
        ...
        "class": bem99("upload-icon")
      }, null), props.uploadText && createVNode("span", {
        "class": bem99("upload-text")
...
var [name105, bem100] = createNamespace("watermark");
var watermarkProps = {
...
var Watermark = withInstall(stdin_default112);
...
var stdin_default115 = (lazyManager) => ({
  props: {
    src: [String, Object],
    tag: {
      type: String,
...
var Lazyload = {
   ...
   */
  install(app, options = {}) {
    const LazyClass = stdin_default113();
    const lazy = new LazyClass(options);
    const lazyContainer = new LazyContainerManager({ lazy });
    app.config.globalProperties.$Lazyload = lazy;
    if (options.lazyComponent) {
      app.component("LazyComponent", stdin_default114(lazy));
    }
    if (options.lazyImage) {
      app.component("LazyImage", stdin_default115(lazy));
    }
    app.directive("lazy", {
...
export {
  ...
  version,
  install,
  stdin_default116 as stdin_default
};
//# sourceMappingURL=chunk-E6AZKFEO.js.map
